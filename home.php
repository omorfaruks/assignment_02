			...
			<div class="row">
				...
				<div class="col-md-7">
					...
					<div class="all-post-area">
						<?php foreach ($fbpost as $fbposts) : ?>
						<div class="user-post-panel">
							<div class="card shadow-sm">
								<div class="card-body">
									<div class="post-header clearfix">
										<img src="<?php echo $fbposts['photo']; ?>" alt="">
										<div class="post-user-info">
											<h4><a href="#"><?php echo $fbposts['name']; ?></a></h4>
											<p><?php echo $fbposts['time']; ?> <i class="fas fa-globe-americas"></i></p>
										</div>
										<a class="float-right" href="#"><i class="fas fa-ellipsis-h"></i></a>
									</div>
									<div class="post-content mt-2">
										<p><?php echo $fbposts['desc']; ?></p>
										<img src="<?php echo $fbposts['image']; ?>" alt="">
									</div>
									<hr>
									<div class="post-likes clearfix">
										<div class="like float-left">
											<img src="assets/media/img/post/like.svg" alt=""> 
											<?php echo $fbposts['like']; ?>
										</div>
										<div class="comment float-right">
										<?php echo $fbposts['comment']; ?> comment
										</div>
									</div>
									<hr>
